...
import type { ServiceFAQ as FAQItem } from "@/lib/data/services";
          ...
          {faqs.map((faq, i) => {
            ...
            return (
              <div key={i} className="border-b border-gold-light">
                ...
                >
                  <span className="font-body text-[15px] text-brown-deep font-medium pr-4">{faq.q}</span>
                  <ChevronDown size={18} className={`text-gold shrink-0 transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`} />
                </button>
